...
#define FOREGROUND_STAR_IMAGE_NAME @"2x_star_bigfull"
#define BACKGROUND_STAR_IMAGE_NAME @"2x_star_bigempty"
#define DEFALUT_STAR_NUMBER 5
#define ANIMATION_TIME_INTERVAL 0.2

@interface UserStarRateView ()

@property (nonatomic, strong) UIView *foregroundStarView;
@property (nonatomic, strong) UIView *backgroundStarView;
@property (nonatomic, strong) CommentCommitViewController *evaluation;
@property (nonatomic, assign) NSInteger numberOfStars;

@end

@implementation UserStarRateView
...
- (void)layoutSubviews {
    ...
    __weak UserStarRateView *weakSelf = self;
